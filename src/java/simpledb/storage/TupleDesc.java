...
//        return 0;
    ...
    public String getFieldName(int i) throws NoSuchElementException {
        ...
        if (this.tableAlias != null)
            return this.tableAlias + "." + tdItems[i].fieldName;
...
//        return null;
    ...
    public int fieldNameToIndex(String name) throws NoSuchElementException {
        ...
        for(int i = 0; i < this.tdItems.length; ++i){
            if (this.tdItems[i].fieldName == null) continue;
...
//        return null;
    ...
    public boolean equals(Object o) {
        ...
        // 判断o是否是TupleDesc的实例, this是当前的TupleDesc对象

        if(this.getClass().isInstance(o)) {
            TupleDesc two = (TupleDesc) o;
            if (this.numFields() == two.numFields()) {
